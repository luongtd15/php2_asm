                ...
                <div class="row col-50 mb-minus-24">
                    <div class="col-lg-3 col-6 cr-product-box mb-24">
                        <div class="cr-product-card">
                            ...
                            <div class="cr-product-details">
                                ...
                                <a href="http://localhost/PHP2/asm/product/1" class="title">Fresh organic villa farm lomon
                                    500gm pack</a>
                    ...
                    <div class="col-lg-3 col-6 cr-product-box mb-24">
                        <div class="cr-product-card">
                            ...
                            <div class="cr-product-details">
                                ...
                                <a href="http://localhost/PHP2/asm/product/2" class="title">Best snakes with hazel nut pack
                                    200gm</a>
                                <p class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                    eiusmod tempor incididunt
                                    ut labore lacus vel facilisis.</p>
                    ...
                    <div class="col-lg-3 col-6 cr-product-box mb-24">
                        <div class="cr-product-card">
                            ...
                            <div class="cr-product-details">
                                ...
                                <a href="http://localhost/PHP2/asm/product/1" class="title">Fresh organic apple 1kg simla
                                    marming</a>
                                <p class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                    eiusmod tempor incididunt
                                    ut labore lacus vel facilisis.</p>
                    ...
                    <div class="col-lg-3 col-6 cr-product-box mb-24">
                        <div class="cr-product-card">
                            ...
                            <div class="cr-product-details">
                                ...
                                <a href="http://localhost/PHP2/asm/product/1" class="title">Organic fresh venila farm
                                    watermelon 5kg</a>
                                <p class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                    eiusmod tempor incididunt
                                    ut labore lacus vel facilisis.</p>
                    ...
                    <div class="col-lg-3 col-6 cr-product-box mb-24">
                        <div class="cr-product-card">
                            ...
                            <div class="cr-product-details">
                                ...
                                <a href="http://localhost/PHP2/asm/product/1" class="title">Sweet crunchy nut mix 250gm
                                    pack</a>
                                <p class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                    eiusmod tempor incididunt
                                    ut labore lacus vel facilisis.</p>
                    ...
                    <div class="col-lg-3 col-6 cr-product-box mb-24">
                        <div class="cr-product-card">
                            <div class="cr-product-image">
                                <div class="cr-image-inner zoom-image-hover">
                                    <img src="http://localhost/PHP2/asm/image/product/17.jpg" alt="product-1">
                                </div>
                                <div class="cr-side-view">
                                    <a href="javascript:void(0)" class="wishlist">
                                        <i class="ri-heart-line"></i>
                            ...
                            <div class="cr-product-details">
                                ...
                                <a href="http://localhost/PHP2/asm/product/1" class="title">Delicious white baked fresh bread
                                    and toast</a>
                                <p class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                    eiusmod tempor incididunt
                                    ut labore lacus vel facilisis.</p>
                    ...
                    <div class="col-lg-3 col-6 cr-product-box mb-24">
                        <div class="cr-product-card">
                            <div class="cr-product-image">
                                <div class="cr-image-inner zoom-image-hover">
                                    <img src="http://localhost/PHP2/asm/image/product/13.jpg" alt="product-1">
                                </div>
                                <div class="cr-side-view">
                                    <a href="javascript:void(0)" class="wishlist">
                                        <i class="ri-heart-line"></i>
                    ...
                    <div class="col-lg-3 col-6 cr-product-box mb-24">
                        <div class="cr-product-card">
                            <div class="cr-product-image">
                                <div class="cr-image-inner zoom-image-hover">
                                    <img src="http://localhost/PHP2/asm/image/product/11.jpg" alt="product-1">
                                </div>
                                <div class="cr-side-view">
                                    <a href="javascript:void(0)" class="wishlist">
                                        <i class="ri-heart-line"></i>
                    ...
                    <div class="col-lg-3 col-6 cr-product-box mb-24">
                        <div class="cr-product-card">
                            <div class="cr-product-image">
                                <div class="cr-image-inner zoom-image-hover">
                                    <img src="http://localhost/PHP2/asm/image/product/12.jpg" alt="product-1">
                                </div>
                                <div class="cr-side-view">
                                    <a href="javascript:void(0)" class="wishlist">
                                        <i class="ri-heart-line"></i>
                    ...
                    <div class="col-lg-3 col-6 cr-product-box mb-24">
                        <div class="cr-product-card">
                            ...
                            <div class="cr-product-details">
                                ...
                                <a href="http://localhost/PHP2/asm/product/1" class="title">Best snakes with hazel nut pack
                                    200gm</a>
                                <p class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                    eiusmod tempor incididunt
                                    ut labore lacus vel facilisis.</p>
                ...
                <div class="row">
                    <div class="col-md-5 col-sm-12 col-xs-12">
                        <div class="zoom-image-hover modal-border-image">
                            <img src="http://localhost/PHP2/asm/image/product/tab-1.jpg" alt="product-tab-2" class="product-image">
                        </div>
                    </div>
